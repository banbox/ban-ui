<template>
  ...
  <div ref="period_bar" class="klinecharts-pro-period-bar">
    <div class='menu-container'>
      <svg
        :class="{rotate: !store.showDrawBar}"
        viewBox="0 0 1024 1024"
        @click="store.showDrawBar = !store.showDrawBar">
    ...
    <span class="item period" @click="showPeriodModal = true">
      {{period.text}}
    </span>
    ...
    <div class='item tools' @click="showTimezoneModal = true">
      <svg viewBox="0 0 20 20">
    ...
    <div class='item tools' @click="showSettingModal = true">
      <svg viewBox="0 0 20 20">
    ...
    <div class='item tools' @click="clickScreenShot">
      <svg viewBox="0 0 20 20">
...
const period = ref(defaults.period)
...
onMounted(() => {
  watch(klocal.symbol, (symbol) => {
    showName.value = symbol.shortName ?? symbol.name ?? symbol.ticker
  }, {immediate: true})
  watch(klocal.period, (p) => {
    period.value = p
  }, {immediate: true})
})
...
function exitFullscreen() {
  ...
  const exitFullscreen = elem.exitFullscreen ?? elem.mozCancelFullScreen ??
